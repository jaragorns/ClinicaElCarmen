...
class VacacionesController extends Controller
{
	...
	public function accessRules()
	{
		return array(
			...
			array('allow',  // allow all users to perform 'index' and 'view' actions
				...
				'roles'=>array('Jefe_Farmacia','Jefe_Enfermeria','Administrador_Admin'),
			),
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Vacaciones']))
		{
			...
			if($model->save()){
				Yii::app()->user->setFlash('success','Vacaciones agregadas.');	
				$this->redirect(array('view','id'=>$model->id_vacaciones));
			}
		}
	...
	public function actionUpdate($id)
	{
		...
		if(isset($_POST['Vacaciones']))
		{
			$model->attributes=$_POST['Vacaciones'];
			if($model->save()){
				Yii::app()->user->setFlash('success','Vacaciones modificadas.');
				$this->redirect(array('view','id'=>$model->id_vacaciones));
			}
		}
