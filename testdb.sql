...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 22-06-2018 a las 02:41:17
...
--
-- Estructura de tabla para la tabla `bitacora_stock`
--

CREATE TABLE `bitacora_stock` (
  `id_bitacora_stock` int(30) NOT NULL,
  `id_usuario` int(30) NOT NULL,
  `id_estacion_origen` int(30) NOT NULL,
  `id_estacion_destino` int(30) NOT NULL,
...
CREATE TABLE `guardias` (
  `id_guardia` int(11) NOT NULL,
  `fecha` varchar(20) DEFAULT '2018/01/01',
  `id_turno` int(11) DEFAULT '3',
...
INSERT INTO `guardias` (`id_guardia`, `fecha`, `id_turno`, `id_usuario`, `id_estacion`, `mes`, `ano`, `dia_1`, `dia_2`, `dia_3`, `dia_4`, `dia_5`, `dia_6`, `dia_7`, `dia_8`, `dia_9`, `dia_10`, `dia_11`, `dia_12`, `dia_13`, `dia_14`, `dia_15`, `dia_16`, `dia_17`, `dia_18`, `dia_19`, `dia_20`, `dia_21`, `dia_22`, `dia_23`, `dia_24`, `dia_25`, `dia_26`, `dia_27`, `dia_28`, `dia_29`, `dia_30`, `dia_31`) VALUES
(3, '2018/5/30', 3, 20, 1, '5', '2018', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 5, 5),
(4, '2018/05/30', 3, 20, 1, '6', '2018', 4, 4, 8, 4, 4, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(5, '2018/5/30', NULL, 20, 1, '7', '2018', NULL, 3, NULL, NULL, NULL, NULL, NULL, 4, NULL, 8, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 4, 4, 3, 3, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
INSERT INTO `unidad_medidas` (`id_unidad_medidas`, `descripcion`, `abreviatura`) VALUES
(1, 'Miligramo', 'mg');
...
--
-- Indices de la tabla `bitacora_stock`
--
ALTER TABLE `bitacora_stock`
  ADD PRIMARY KEY (`id_bitacora_stock`);
...
--
-- AUTO_INCREMENT de la tabla `bitacora_stock`
--
ALTER TABLE `bitacora_stock`
  MODIFY `id_bitacora_stock` int(30) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `guardias`
  MODIFY `id_guardia` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
ALTER TABLE `unidad_medidas`
  MODIFY `id_unidad_medidas` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
